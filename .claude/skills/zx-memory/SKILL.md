...
```
48k    ' UNIT   :Red Base  025/025 R0 M0'    perfect
128k   ' ?NI?   :Red B?se   2?/ 2? R  ? '    corrupt
```
...
*Laying out a NEW project?  `.claude/skills/zx0-layout` covers the
...
`Adventure C - The Ship of Doom.ch8` fails with
